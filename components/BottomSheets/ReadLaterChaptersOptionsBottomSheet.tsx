...
interface Props {}
const ReadLaterChaptersOptionBottomSheet = React.forwardRef<
  BottomSheetModal,
  Props
>(({}, ref) => {
  const snapPoints = React.useMemo(() => ["15%"], []);
  const { clear } = useReaderLaterStore();
...
export default ReadLaterChaptersOptionBottomSheet;
